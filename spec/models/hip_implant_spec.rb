...
describe HipImplant do
  ...
  should_validate_inclusion_of :femur_diameter, :in => HipImplant::femur_diameters, :allow_nil => true
  should_validate_inclusion_of :femur_length, :in => HipImplant::femur_lengths, :allow_nil => true
  should_validate_inclusion_of :acetabulum_size, :in => HipImplant::acetabulum_sizes, :allow_nil => true
  should_validate_inclusion_of :femur_head_size, :in => HipImplant::femur_head_sizes, :allow_nil => true
  should_validate_inclusion_of :neck_length, :in => HipImplant::neck_lengths, :allow_nil => true
